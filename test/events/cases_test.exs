defmodule Events.CasesTest do
  ...
  describe "cases" do
    ...
    @invalid_attrs %{archived_at: nil, closed_at: nil, created_at: nil, deleted_at: nil, description: nil, identifier: nil, is_archived: nil, opened_at: nil, status: nil, status_note: nil, title: nil, updated_at: nil}
    ...
    test "create_case/1 with valid data creates a case" do
      valid_attrs = %{archived_at: ~U[2024-03-07 08:58:00Z], closed_at: ~U[2024-03-07 08:58:00Z], created_at: ~U[2024-03-07 08:58:00Z], deleted_at: ~U[2024-03-07 08:58:00Z], description: "some description", identifier: "some identifier", is_archived: true, opened_at: ~U[2024-03-07 08:58:00Z], status: "some status", status_note: "some status_note", title: "some title", updated_at: ~U[2024-03-07 08:58:00Z]}
    ...
    test "update_case/2 with valid data updates the case" do
      case = case_fixture()
      update_attrs = %{archived_at: ~U[2024-03-08 08:58:00Z], closed_at: ~U[2024-03-08 08:58:00Z], created_at: ~U[2024-03-08 08:58:00Z], deleted_at: ~U[2024-03-08 08:58:00Z], description: "some updated description", identifier: "some updated identifier", is_archived: false, opened_at: ~U[2024-03-08 08:58:00Z], status: "some updated status", status_note: "some updated status_note", title: "some updated title", updated_at: ~U[2024-03-08 08:58:00Z]}
