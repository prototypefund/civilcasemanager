defmodule CaseManagerWeb do
  ...
  def static_paths,
    do:
      ~w(assets fonts images favicon.ico favicon.svg robots.txt site.webmanifest apple-touch-icon.png favicon-48x48.png web-app-manifest-192x192.png web-app-manifest-512x512.png)
