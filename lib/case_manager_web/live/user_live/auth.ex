defmodule CaseManagerWeb.UserLive.Auth do
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      CaseManagerWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_user:
      ...
      defmodule CaseManagerWeb.PageLive do
        use CaseManagerWeb, :live_view

        on_mount {CaseManagerWeb.UserLive.Auth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{CaseManagerWeb.UserLive.Auth, :ensure_authenticated}] do
