    ...
    <div>
      ...
      >
        ...
        <div class="flex gap-4 flex-row flex-wrap">
          <.input field={@form[:pob_total]} type="number" label="Total" wrapper_class="w-2/5 flex-grow" />
          <.input field={@form[:pob_men]} type="number" label="Men" wrapper_class="w-2/5 flex-grow" />
          <.input field={@form[:pob_women]} type="number" label="Women" wrapper_class="w-2/5 flex-grow" />
          <.input field={@form[:pob_minors]} type="number" label="Minors" wrapper_class="w-2/5 flex-grow" />
          <.input field={@form[:pob_gender_ambiguous]} type="number" label="Gender ambigous" wrapper_class="w-2/5 flex-grow" />
          <.input field={@form[:pob_medical_cases]} type="number" label="Medical Cases" wrapper_class="w-2/5 flex-grow" />
          <.input field={@form[:people_dead]} type="number" label="Dead" wrapper_class="w-2/5 flex-grow" />
          <.input field={@form[:people_missing]} type="number" label="Missing" wrapper_class="w-2/5 flex-grow" />
          <.input field={@form[:pob_per_nationality]} type="text" label="Per nationality" wrapper_class="w-2/5 flex-grow" />
        </div>

        <h1 class="text-indigo-600 pt-8 font-semibold">Outcome</h1>
        <.input field={@form[:outcome]} type="text" label="Outcome" />
        <.input field={@form[:time_of_disembarkation]} type="datetime-local" label="Time of Disembarkation" />
