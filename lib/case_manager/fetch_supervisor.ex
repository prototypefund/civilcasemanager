defmodule CaseManager.FetchSupervisor do
  use Supervisor
  ...
  def init(opts) do
    ...
    if manager_pid == nil do
      ...
      Application.put_env(:case_manager, :type_registry, type_registry)
  ...
  def get_icon_for(event_type) do
    type_registry = Application.get_env(:case_manager, :type_registry, %{})
